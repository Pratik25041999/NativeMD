...
class SetLifeStyle6 extends StatefulWidget {
  const SetLifeStyle6({Key? key}) : super(key: key);

  @override
  _SetLifeStyle6State createState() => _SetLifeStyle6State();
}

class _SetLifeStyle6State extends State<SetLifeStyle6> {
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: textCS(
                "Do you have any injuries in past?",
                size: 16,
              ),
            ),
            height(16),
